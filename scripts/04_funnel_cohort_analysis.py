...
users = pd.read_csv("../data/generated/users_master.csv", parse_dates=["signup_date"])
...
# Save all outputs
funnel1_df.to_csv("../data/generated/funnel1_purchase_journey.csv", index=False, encoding="utf-8-sig")
funnel2_df.to_csv("../data/generated/funnel2_reaction_journey.csv", index=False, encoding="utf-8-sig")
cohort_A_pct.to_csv("../data/generated/cohort_A_repurchase_pct.csv", encoding="utf-8-sig")
cohort_B_pct.to_csv("../data/generated/cohort_B_repurchase_pct.csv", encoding="utf-8-sig")
cohort_A_cnt.to_csv("../data/generated/cohort_A_size.csv", encoding="utf-8-sig")
cohort_B_cnt.to_csv("../data/generated/cohort_B_size.csv", encoding="utf-8-sig")
